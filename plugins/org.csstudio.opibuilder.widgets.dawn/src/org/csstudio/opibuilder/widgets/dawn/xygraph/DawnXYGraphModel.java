...
public class DawnXYGraphModel extends AbstractPVWidgetModel {
     ...
     */
    public static final String ID = "org.csstudio.opibuilder.widgets.dawn.xygraph"; //$NON-NLS-1$
...
//        case CHRONOLOGICAL:
        ...
        case LINE_WIDTH:
            ...
            break;
        case PLOTMODE:
            addProperty(new ComboProperty(propID, traceProperty.toString(), category, CircularBufferDataProvider.PlotMode.stringValues(),
                    0));
            break;
        case POINT_SIZE:
